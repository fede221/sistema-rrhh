# Script para construir y subir las imagenes de Docker con tag v121
# Ejecutar desde la raiz del proyecto

Write-Host "=== Sistema RRHH - Build y Push de Imagenes Docker v121 ===" -ForegroundColor Cyan
Write-Host ""
...
if ($uploadsCount -eq 0) {
    Write-Host "Advertencia: No se encontraron archivos PNG en backend/uploads/" -ForegroundColor Yellow
}
else {
...
Write-Host ""
Write-Host "Imagenes creadas y subidas:" -ForegroundColor Cyan
Write-Host "  - $BACKEND_IMAGE" -ForegroundColor White
Write-Host "  - $FRONTEND_IMAGE" -ForegroundColor White
Write-Host ""
Write-Host "Tag: v121" -ForegroundColor Green
