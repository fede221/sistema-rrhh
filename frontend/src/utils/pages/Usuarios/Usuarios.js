  ...
  try {
    ...
    for (let i = 0; i < datosImportar.length; i += tamanoLote) {
      ...
      try {
        ...
        const response = await apiRequest('/usuarios/importar-masivo', {
          method: 'POST',
  ...
  try {
    ...
    for (let i = 0; i < datosImportar.length; i += tamanoLote) {
      ...
      try {
        ...
        const response = await apiRequest('/usuarios/actualizar-legajos', {
          method: 'POST',
          body: JSON.stringify(payload)
        });
  ...
  try {
    ...
    for (let i = 0; i < datosAdicionales.length; i += tamanoLote) {
      ...
      try {
        ...
        const response = await apiRequest('/legajos/actualizar-datos-adicionales', {
          method: 'POST',
          body: JSON.stringify(payload)
        });
...
const descargarPlantilla = async () => {
  try {
    ...
    const response = await apiRequest('/usuarios/plantilla-excel', {
      method: 'GET',
      returnRaw: true
    });
