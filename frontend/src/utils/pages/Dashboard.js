...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch estadísticas
      const statsData = await apiRequest('/dashboard/estadisticas');
      
      // Fetch perfil
      const perfilData = await apiRequest('/dashboard/perfil');
      
      // Fetch alertas
      const alertasData = await apiRequest('/dashboard/alertas');
